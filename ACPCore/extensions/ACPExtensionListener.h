...
/// Creates a new listener who is owned by `extension
/// @param extension the extension who owns this listener
- (nullable instancetype) initWithExtension: (nonnull ACPExtension*) extension;
 ...
 */
@property(nonatomic) ACPExtension* _Nonnull extension;
