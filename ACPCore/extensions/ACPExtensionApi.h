...
/// Creates a new extension API backed by the extension runtime
/// @param runtime the extension runtime provided by the event hub
...
/// Sets the extension for this extension API
/// @param extension extension who owns this instance of the API
- (void)setExtension:(nonnull ACPExtension *) extension;
