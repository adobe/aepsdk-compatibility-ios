...
/**
 * @brief Returns the current version of the Audience Manager Extension.
 */
+ (nonnull NSString*) extensionVersion;

/**
 * @brief Registers the Audience extension
 *
 * This method should be called before any other Audience Manager API is called
 */
